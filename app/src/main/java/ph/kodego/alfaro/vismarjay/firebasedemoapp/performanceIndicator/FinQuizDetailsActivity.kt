...
import ph.kodego.alfaro.vismarjay.firebasedemoapp.adapter.FinQuizListAdapter
import ph.kodego.alfaro.vismarjay.firebasedemoapp.adapter.MidQuizListAdapter
import ph.kodego.alfaro.vismarjay.firebasedemoapp.databinding.ActivityFinQuizDetailsBinding
import ph.kodego.alfaro.vismarjay.firebasedemoapp.models.ActivityListModel

class FinQuizDetailsActivity : AppCompatActivity(), FinQuizListAdapter.onItemClickListener {

    private lateinit var binding: ActivityFinQuizDetailsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityFinQuizDetailsBinding.inflate(layoutInflater)
    ...
    private fun getActivityData() {
        ...
        val finQuizListRef = currentUser?.let {
            courseId?.let { it1 ->
        ...
        if (finQuizListRef != null) {
            finQuizListRef.addValueEventListener(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    val adapter = FinQuizListAdapter(activityList, this@FinQuizDetailsActivity) // pass this as listener
    ...
    override fun onItemClick(position: Int) {
        ...
        val intent = Intent(this, FinQuizActivity::class.java).apply {
    ...
    private fun openUpdateDialog() {
        ...
        mDialog.setTitle("Updating Final Quizzes")
