...
import ph.kodego.alfaro.vismarjay.firebasedemoapp.activities.StudentScoreFinExam
import ph.kodego.alfaro.vismarjay.firebasedemoapp.activities.StudentScoreMidExam
import ph.kodego.alfaro.vismarjay.firebasedemoapp.adapter.FinExamAdapter
import ph.kodego.alfaro.vismarjay.firebasedemoapp.adapter.MidExamAdapter
import ph.kodego.alfaro.vismarjay.firebasedemoapp.databinding.ActivityFinExamBinding
...
class FinExamActivity : AppCompatActivity(), FinExamAdapter.onItemClickListener {

    private lateinit var binding:ActivityFinExamBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityFinExamBinding.inflate(layoutInflater)
        ...
        if (dbRef != null) {
            dbRef.addValueEventListener(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    binding.finExamTotalScore.text = totalScore.toString()
                }
        ...
        binding.finExam.setOnClickListener{
        ...
        if (enstudentRef != null) {
            enstudentRef.addValueEventListener(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    val adapter = FinExamAdapter(studentList, this@FinExamActivity) // pass this as listener
    ...
    override fun onItemClick(position: Int) {
        ...
        val intent = Intent(this, StudentScoreFinExam::class.java).apply {
            ...
            putExtra("ACTIVITY_TITLE", binding.finExam.text.toString())
            putExtra("SCORE_TOTAL", binding.finExamTotalScore.text.toString().replace("Total: ", ""))
        }
    ...
    private fun openUpdateDialog(courseId: String) {
        ...
        mDialog.setTitle("UPDATING FINAL EXAM")
    ...
    private fun updatePiData(
        ...
        binding.finExamTotalScore.text = etPiTotal.toString()
    }
