...
import ph.kodego.alfaro.vismarjay.firebasedemoapp.activities.StudentScoreFinQuiz
import ph.kodego.alfaro.vismarjay.firebasedemoapp.adapter.FinQuizAdapter
import ph.kodego.alfaro.vismarjay.firebasedemoapp.databinding.ActivityFinQuizBinding
import ph.kodego.alfaro.vismarjay.firebasedemoapp.models.EnrolledStudentModel

class FinQuizActivity : AppCompatActivity(), FinQuizAdapter.onItemClickListener {

    private lateinit var binding:ActivityFinQuizBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityFinQuizBinding.inflate(layoutInflater)
        ...
        binding.finQuizNo.text = activityTitle
        ...
        if (enstudentRef != null) {
            enstudentRef.addValueEventListener(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    val adapter = FinQuizAdapter(studentList, this@FinQuizActivity) // pass this as listener
    ...
    override fun onItemClick(position: Int) {
        ...
        val intent = Intent(this, StudentScoreFinQuiz::class.java).apply {
            ...
            putExtra("ACTIVITY_TITLE", binding.finQuizNo.text.toString())
