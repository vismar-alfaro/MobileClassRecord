...
class MidPitAdapter (private val enrolledStudentList: ArrayList<EnrolledStudentModel>, private val listener: MidPitActivity):
    RecyclerView.Adapter<MidPitAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType:Int): MidPitAdapter.ViewHolder{
    ...
    override fun onBindViewHolder(holder: MidPitAdapter.ViewHolder, position:Int){
