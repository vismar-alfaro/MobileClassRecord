...
import ph.kodego.alfaro.vismarjay.firebasedemoapp.adapter.FinActivityListAdapter
import ph.kodego.alfaro.vismarjay.firebasedemoapp.databinding.ActivityFinActDetailsBinding
import ph.kodego.alfaro.vismarjay.firebasedemoapp.models.ActivityListModel

class FinActDetailsActivity : AppCompatActivity(), FinActivityListAdapter.onItemClickListener {

    private lateinit var binding: ActivityFinActDetailsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityFinActDetailsBinding.inflate(layoutInflater)
    ...
    private fun getActivityData() {
        ...
        val finActListRef = currentUser?.let {
            courseId?.let { it1 ->
        ...
        if (finActListRef != null) {
            finActListRef.addValueEventListener(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    val adapter = FinActivityListAdapter(activityList, this@FinActDetailsActivity) // pass this as listener
    ...
    override fun onItemClick(position: Int) {
        ...
        val intent = Intent(this, FinActActivity::class.java).apply {
    ...
    private fun openUpdateDialog() {
        ...
        mDialog.setTitle("Updating Final Activities")
