...
import ph.kodego.alfaro.vismarjay.firebasedemoapp.performanceIndicator.FinActActivity

class FinActAdapter (private val enrolledStudentList: ArrayList<EnrolledStudentModel>, private val listener: FinActActivity):
    RecyclerView.Adapter<FinActAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType:Int): FinActAdapter.ViewHolder{
    ...
    override fun onBindViewHolder(holder: FinActAdapter.ViewHolder, position:Int){
