...
class StudentActivitiesAdapter(private val activityList: ArrayList<ActivityListModel>, private val listener: StudentActivitiesActivity):
    RecyclerView.Adapter<StudentActivitiesAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): StudentActivitiesAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: StudentActivitiesAdapter.ViewHolder, position: Int) {
