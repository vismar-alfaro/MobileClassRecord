...
import ph.kodego.alfaro.vismarjay.firebasedemoapp.databinding.ActivityMidPitBinding
...
class MidPitActivity : AppCompatActivity(), MidPitAdapter.onItemClickListener {

    private lateinit var binding:ActivityMidPitBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMidPitBinding.inflate(layoutInflater)
        ...
        if (dbRef != null) {
            dbRef.addValueEventListener(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    binding.midPitTotalScore.text = totalScore.toString()
                }
        ...
        binding.midPit.setOnClickListener{
        ...
        if (enstudentRef != null) {
            enstudentRef.addValueEventListener(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    val adapter = MidPitAdapter(studentList, this@MidPitActivity) // pass this as listener
    ...
    override fun onItemClick(position: Int) {
        ...
        val intent = Intent(this, StudentScoreMidPit::class.java).apply {
            ...
            putExtra("ACTIVITY_TITLE", binding.midPit.text.toString())
            putExtra("SCORE_TOTAL", binding.midPitTotalScore.text.toString().replace("Total: ", ""))
        }
    ...
    private fun openUpdateDialog(courseId: String) {
        ...
        mDialog.setTitle("UPDATING MIDTERM PIT")
    ...
    private fun updatePiData(
        ...
        binding.midPitTotalScore.text = etPiTotal.toString()
    }
