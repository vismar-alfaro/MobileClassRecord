...
import ph.kodego.alfaro.vismarjay.firebasedemoapp.activities.StudentDashboardActivity
import ph.kodego.alfaro.vismarjay.firebasedemoapp.models.CourseModel

class StudentCourseAdapter (private val courseList: ArrayList<CourseModel>, private val listener: StudentDashboardActivity):
    RecyclerView.Adapter<StudentCourseAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType:Int): StudentCourseAdapter.ViewHolder{
    ...
    override fun onBindViewHolder(holder: StudentCourseAdapter.ViewHolder, position:Int){
