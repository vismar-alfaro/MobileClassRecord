...
class MidQuizAdapter(private val enrolledStudentList: ArrayList<EnrolledStudentModel>, private val listener: MidQuizActivity):
    RecyclerView.Adapter<MidQuizAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType:Int): MidQuizAdapter.ViewHolder{
    ...
    override fun onBindViewHolder(holder: MidQuizAdapter.ViewHolder, position:Int){
