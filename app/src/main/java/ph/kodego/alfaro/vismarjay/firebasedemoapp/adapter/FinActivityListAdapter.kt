...
import ph.kodego.alfaro.vismarjay.firebasedemoapp.performanceIndicator.FinActDetailsActivity

class FinActivityListAdapter(private val activityList: ArrayList<ActivityListModel>, private val listener: FinActDetailsActivity):
    RecyclerView.Adapter<FinActivityListAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType:Int): FinActivityListAdapter.ViewHolder{
    ...
    override fun onBindViewHolder(holder: FinActivityListAdapter.ViewHolder, position:Int){
