...
class MidActAdapter (private val enrolledStudentList: ArrayList<EnrolledStudentModel>, private val listener: MidActActivity):
    RecyclerView.Adapter<MidActAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType:Int): MidActAdapter.ViewHolder{
    ...
    override fun onBindViewHolder(holder: MidActAdapter.ViewHolder, position:Int){
