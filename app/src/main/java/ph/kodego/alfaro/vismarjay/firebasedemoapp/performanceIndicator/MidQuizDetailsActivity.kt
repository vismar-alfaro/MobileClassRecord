...
import ph.kodego.alfaro.vismarjay.firebasedemoapp.databinding.ActivityMidQuizDetailsBinding
import ph.kodego.alfaro.vismarjay.firebasedemoapp.models.ActivityListModel

class MidQuizDetailsActivity : AppCompatActivity(), MidQuizListAdapter.onItemClickListener {

    private lateinit var binding: ActivityMidQuizDetailsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMidQuizDetailsBinding.inflate(layoutInflater)
    ...
    private fun getActivityData() {
        ...
        val midQuizListRef = currentUser?.let {
            courseId?.let { it1 ->
        ...
        if (midQuizListRef != null) {
            midQuizListRef.addValueEventListener(object : ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    val adapter = MidQuizListAdapter(activityList, this@MidQuizDetailsActivity) // pass this as listener
    ...
    override fun onItemClick(position: Int) {
        ...
        val intent = Intent(this, MidQuizActivity::class.java).apply {
    ...
    private fun openUpdateDialog() {
        ...
        mDialog.setTitle("Updating Midterm Quizzes")
