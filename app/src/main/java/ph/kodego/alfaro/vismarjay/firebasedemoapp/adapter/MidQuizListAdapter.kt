...
import ph.kodego.alfaro.vismarjay.firebasedemoapp.performanceIndicator.MidQuizDetailsActivity

class MidQuizListAdapter (private val activityList: ArrayList<ActivityListModel>, private val listener: MidQuizDetailsActivity):
    RecyclerView.Adapter<MidQuizListAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType:Int): MidQuizListAdapter.ViewHolder{
    ...
    override fun onBindViewHolder(holder: MidQuizListAdapter.ViewHolder, position:Int){
