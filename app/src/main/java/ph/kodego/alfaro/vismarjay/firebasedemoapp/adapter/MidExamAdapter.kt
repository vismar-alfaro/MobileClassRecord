...
class MidExamAdapter (private val enrolledStudentList: ArrayList<EnrolledStudentModel>, private val listener: MidExamActivity):
    RecyclerView.Adapter<MidExamAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType:Int): MidExamAdapter.ViewHolder{
    ...
    override fun onBindViewHolder(holder: MidExamAdapter.ViewHolder, position:Int){
